...
const DVector x_0 = {-0.78 , -0.2};
const DVector goal = {-0.85 , -0.38};
...
int main(int argc, char **argv)
{
    ...
    ros::Rate rate(HZ);
    ros::Publisher pathPub = n->advertise<nav_msgs::Path>("dmp/trajectory_tmp",10, true);
...
//    myController.moveToFrame(myController.homeJoint,init_frame,6,true);
    myController.moveToFrame(init_frame,3,true);
    ...
    string file_name = "/home/jiyguo/ur_ws/src/dmp/data/my_dmp_ws_tmp.txt";
...
//        }
        ...
        my_data<<cur_state.positions[0]<<" "<<cur_state.positions[1]<<" ";
        my_data<<couple_term[0]<<" "<<couple_term[1]<<endl;
